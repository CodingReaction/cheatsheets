...
ManyToManyField(Tag,          # "self" for Tag<->Tag relationship
        db_table="user_tags", #autogenerated using the names of both tables
        though="Favoutite",   #use an intermediate table Favourite
        though_fields=("tag", "person",)) # FK in the intermediate table
